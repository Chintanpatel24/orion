...
pub fn palette_items() -> &'static [PaletteItem] {
    &[
        ...
        PaletteItem { name: "Open folder", detail: "Open a persistent workspace folder", action: PaletteAction::OpenFolder },
        ...
        PaletteItem { name: "Git review", detail: "Open the agent-first Git diff review window", action: PaletteAction::GitReview },
        PaletteItem { name: "Refresh Git", detail: "Reload branch and changed files", action: PaletteAction::RefreshGit },
        PaletteItem { name: "Search", detail: "Find text in the current file", action: PaletteAction::Search },
        PaletteItem { name: "Refresh workspace", detail: "Reload the file explorer", action: PaletteAction::RefreshWorkspace },
